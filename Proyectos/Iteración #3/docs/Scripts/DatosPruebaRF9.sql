...
Insert into A_RESERVA (ID,FECHAINI,FECHAFIN,IDENTIFICACIONCLIENTE,IDALOJAMIENTO,ESTADO, IDGRUPO, GANANCIA) values ('3',to_date('12/03/24','DD/MM/RR'),to_date('12/04/24','DD/MM/RR'),'100','4','Y','300','0');
COMMIT;
