...
Insert into A_ALOJAMIENTO (ID,UBICACION,DURACIONMIN,COSTO,ESTATUS) values ('1','oeste','1','99', 'Y');
Insert into A_ALOJAMIENTO (ID,UBICACION,DURACIONMIN,COSTO,ESTATUS) values ('2','oeste','1','99', 'Y');
Insert into A_ALOJAMIENTO (ID,UBICACION,DURACIONMIN,COSTO,ESTATUS) values ('3','oeste','1','99', 'Y');
Insert into A_ALOJAMIENTO (ID,UBICACION,DURACIONMIN,COSTO,ESTATUS) values ('4','oeste','1','99', 'Y');
Insert into A_HABITACIONHOTEL (ID,TIPOHABITACION,TAMANIO,IDHOTEL) values ('1','suite','grande','900');
Insert into A_HABITACIONHOTEL (ID,TIPOHABITACION,TAMANIO,IDHOTEL) values ('2','suite','grande','900');
...
Insert into A_CLIENTE (IDENTIFICACION,NOMBRE,TIPOVINCULO,CORREOELECTRONICO,TELEFONO,ULTIMAFECHARESERVA) values ('100','Hiram','estudiante','heborall2r@nyu.edu','1579959169',to_date('03/12/22','DD/MM/RR'));
Insert into A_RESERVA (ID,FECHAINI,FECHAFIN,IDENTIFICACIONCLIENTE,IDALOJAMIENTO) values ('1',to_date('12/01/24','DD/MM/RR'),to_date('12/02/24','DD/MM/RR'),'100','1');
Insert into A_RESERVA (ID,FECHAINI,FECHAFIN,IDENTIFICACIONCLIENTE,IDALOJAMIENTO) values ('2',to_date('12/03/24','DD/MM/RR'),to_date('12/04/24','DD/MM/RR'),'100','1');
Insert into A_RESERVA (ID,FECHAINI,FECHAFIN,IDENTIFICACIONCLIENTE,IDALOJAMIENTO) values ('3',to_date('12/05/24','DD/MM/RR'),to_date('12/06/24','DD/MM/RR'),'100','1');
COMMIT;